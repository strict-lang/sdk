...
type MethodDefinition struct {
	...
	declaration *syntaxtree2.MethodDeclaration
...
func (generation *Generation) NewMethodGeneration(method *syntaxtree2.MethodDeclaration) *MethodDefinition {
...
func (generation *Generation) GenerateMethod(method *syntaxtree2.MethodDeclaration) {
...
func (definition *MethodDefinition) generateBody() string {
	...
	if block, ok := definition.declaration.Body.(*syntaxtree2.BlockStatement); ok {
