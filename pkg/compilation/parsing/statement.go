...
func (parsing *Parsing) findKeywordStatementParser(keyword token.Keyword) (func() syntaxtree.Node, bool) {
	switch keyword {
...
func (parsing *Parsing) parseFieldDeclarationOrListAccess() (syntaxtree.Node, error) {
	...
	operation, err := parsing.parseOperationsOnOperand(&syntaxtree.Identifier{
